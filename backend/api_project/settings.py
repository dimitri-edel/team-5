...
INSTALLED_APPS = [
    ...
    'allauth.socialaccount.providers.google',  # Add the social providers you need
...
CORS_ALLOWED_ORIGINS = os.getenv('CORS_ALLOWED_ORIGINS', 'http://localhost:5173,https://team5-frontend-eu-f40f1bfc04e7.herokuapp.com').split(',')
...
# Add this setting to use JWT with dj-rest-auth
REST_USE_JWT = True
